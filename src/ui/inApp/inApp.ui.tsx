  ...
  return (
    <div className="lg:min-h-screen bg-ctz-gray-aultra_light pt-20 lg:pt-40 ctz-padding">
      ...
      <div className="flex flex-col lg:flex-row pb-20">
        ...
        <div className="w-full lg:w-[40%] min-h-full relative">
          <Image src={'/images/tablet.png'} alt='Avatar on device' fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" style={{ objectFit: 'contain' }} />
          <div ref={phone} className="absolute inset-0">
            <Image src={'/images/phone.png'} alt='Avatar on device' fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" style={{ objectFit: 'contain' }} className="-translate-x-1/3"/>
          </div>
        </div>
      </div>
    </div>
