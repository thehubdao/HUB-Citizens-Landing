...
export default function InAppUI() {
  return (
    <div className="lg:min-h-screen bg-ctz-gray-aultra_light pt-20 lg:pt-40 ctz-padding">
      <h1 className="uppercase text-ctz-gray-dark text-[7.8vw] lg:text-[8.9vw] leading-[80%] text-center">In-App Iframe <br /><span className="uppercase text-ctz-gray-dark text-[9.2vw] lg:text-[10.5vw] leading-[80%]">Integration</span></h1>
      <div className="py-10">
        <ColorsBarUI />
      </div>
      <div className="flex flex-col lg:flex-row pb-20">
        <div className="w-full lg:w-[60%] text-center lg:text-start ">
          ...
          <IconButtonUI iconColor={'fill-ctz-pink-medium'} icon={ButtonIcon.arrow} borderColor={ButtonBorderColor.Black}>
