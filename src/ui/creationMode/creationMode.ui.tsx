  ...
  return (
    <div className="bg-ctz-gray-aultra_light ctz-padding relative pb-20 lg:pb-32">
      <div className="flex flex-col lg:flex-row">
        <div className="border-[2px] border-b-0 lg:border-r-0 border-ctz-gray-dark flex flex-col items-center">
          ...
          <div className="p-4 lg:p-0">
            <IconButtonUI iconColor={'fill-ctz-yellow-medium'} icon={ButtonIcon.arrow}>
              <p className='text-[4vw] lg:text-[2vw] leading-[80%] uppercase text-ctz-pink-light px-4 lg:px-12 text-center'>Upload your<br />own creations!</p>
            </IconButtonUI>
          </div>
        </div>
        <div className="border-[2px] border-ctz-gray-dark w-full">
